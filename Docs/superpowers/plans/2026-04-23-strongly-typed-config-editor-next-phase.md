...
- Task 1 completed: workspace exclude matcher added with tests.
- Task 2 completed: workspace settings JSON store added with tests.
- Task 3 completed: workspace tree now applies hide rules and can show hidden entries in gray.
- Task 4 completed: table layout options added and wired into grid host and sheet rendering.
- Task 5 completed: settings view model added with Apply/Confirm/Cancel/Reset tests.
- Task 6 completed: settings toolbar entry now opens a settings dialog.
- Task 7 completed: docs updated and verification commands run.
- Commits skipped: the user did not explicitly authorize committing from this session.
- Windows manual run skipped in this environment; automated build and tests were run instead.
